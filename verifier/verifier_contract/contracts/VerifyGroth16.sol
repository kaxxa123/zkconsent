...
// AlexZ: Code based on Zeth's Groth16 verifier

contract VerifiyGroth16 {
    ...
    function setVerifyingKey(uint256[] memory vkIn) public 
    {
    ...
    function verifyTx(
            ...
            uint256[] memory input) public returns (bool) {
