             ...
             const boost::filesystem::path &witness_out_file)
{
    ...
    write_proof_to_file(ext_proof.get_proof(), proof_out_file);
    write_assignment_to_file(ext_proof.get_primary_inputs(), primary_out_file);
