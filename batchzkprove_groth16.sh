...
./snarks/build/zkconsent/zkconsent prove --groth16 --zkconfirm   -w ./samples/zkconfirm_other.json \
            --extproof-json $HOME/zkconsent_setup/groth16/other/zkconf/exproof_zkconf.json \
            --proof-bin     $HOME/zkconsent_setup/groth16/other/zkconf/proof_zkconf.bin \
            --primary-bin   $HOME/zkconsent_setup/groth16/other/zkconf/primary_zkconf.bin \
            --witness-bin   $HOME/zkconsent_setup/groth16/other/zkconf/witness_zkconf.bin
...
python3 ./verifier/groth16_hlp/convertproof.py $HOME/zkconsent_setup/groth16/other/zkconf/exproof_zkconf.json $HOME/zkconsent_setup/groth16/other/zkconf/exproof_zkconf_params.json
